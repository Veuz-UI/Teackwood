...
<body>
    ...
    <section class="space-section-inner">
        <div class="container">
            <h2 class="study-table">Study Table</h2>
            <div class="row">
                <div class="col-lg-3" data-aos="fade-up">
                    <a href="product-details.php" style="text-decoration:none;">
                ...
                <div class="col-lg-3" data-aos="fade-up">
                    <a href="product-details.php" style="text-decoration:none;">
                        <div class="product-box-col">
                            ...
                            <div class="product-img">
                                <img src="images/product/product2.webp" class="img-fluid">
                            </div>
                            <div class="product-info">
                                <h2>Truman Solid Wood Study Table In Teak Finish</h2>
                ...
                <div class="col-lg-3" data-aos="fade-up">
                    <a href="product-details.php" style="text-decoration:none;">
                        <div class="product-box-col">
                            ...
                            <div class="product-img">
                                <img src="images/product/product8.webp" class="img-fluid">
                            </div>
                            <div class="product-info">
                                <h2>Truman Solid Wood Study Table In Teak Finish</h2>
                ...
                <div class="col-lg-3" data-aos="fade-up">
                    <a href="product-details.php" style="text-decoration:none;">
                        <div class="product-box-col">
                            ...
                            <div class="product-img">
                                <img src="images/product/product7.webp" class="img-fluid">
                            </div>
                            <div class="product-info">
                                <h2>Truman Solid Wood Study Table In Teak Finish</h2>
